...
var tourismPlaceList = [
  TourismPlace(
    ...
    imageUrl: 'https://media-cdn.tripadvisor.com/media/photo-s/0d/7c/59/70/farmhouse-lembang.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageUrl:     'https://www.backroadstexas.net/calendars/vrp/rentals/prop1373_oldfelltw_1920w.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageUrl:     'https://media-cdn.tripadvisor.com/media/photo-m/1280/16/a9/33/43/liburan-di-farmhouse.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageUrl:     'https://www.backroadstexas.net/calendars/vrp/rentals/prop1373_5r7a2715-edit_1920w.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
      imageUrl:     'https://www.backroadstexas.net/calendars/vrp/rentals/prop1373_5r7a2481-edit_1920w.jpg',
      imageUrls: [
  ...
  TourismPlace(
    ...
    imageUrl:     'https://www.backroadstexas.net/calendars/vrp/rentals/prop1373_5r7a2684_1920w.jpg',
    imageUrls: [
